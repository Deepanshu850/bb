...
document.addEventListener("turbo:load", function () {
    ...
    if (darkMode == 1) {
        ...
        CKEDITOR.addCss(
            ".cke_editable { background-color: #14151F; color: white; border-color: black; }"
        );
    }
});
...
window.deleteItem = function (url, header) {
    ...
    swal({
        ...
        text: Lang.get("js.delete_warning") + ' "' + header + '"' + " ?",
        buttons: {
...
window.isValidFile = function (inputSelector, validationMessageSelector) {
    ...
    if ($.inArray(ext, ["gif", "png", "jpg", "jpeg"]) == -1) {
        ...
        $(validationMessageSelector).html(Lang.get("js.allowed_types")).show();
...
$(document).on("click", ".change-type-login", function (e) {
