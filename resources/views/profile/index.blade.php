                ...
                <div class="card">
                    ...
                    <div class="collapse show">
                        <div class="card-body p-9">
                                            ...
                                            <div class="d-block">
                                                <div class="image-picker">
                                                    @php
                                                      ...
                                                      $style = 'style="background-image: url(\''.urldecode($user->profile_image).'\')"';
                                                    @endphp
                            ...
                            <div class="row mb-6">
                                <label class="col-lg-4 form-label required ">{{ __('messages.staff.username').':' }}</label>
                                <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                    {{ Form::text('username', $user->username, ['class'=> 'form-control', 'placeholder' => __('messages.staff.username'), 'required']) }}
                                </div>
                            </div>
                            <div class="row mb-6">
                            ...
                            <div class="row mb-6">
                                <label class="col-lg-4 form-label">{{ __('messages.staff.about_us').':' }}</label>
                                <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                    <div>
                                        {{ Form::textarea('about_us', $user->about_us, ['class' => 'form-control','id' => 'description', 'placeholder' =>  __('messages.staff.about_us'), 'rows'=>'5']) }}
                                    </div>
                                </div>
                            </div>
                        </div>
