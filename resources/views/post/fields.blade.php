    ...
    <div class="card">
        <div class="card-body">
            <div>
                <div class="p-0">
                    ...
                    @else
                        <div class="mb-5">
                            ...
                            <div class="d-flex">
                                {{ Form::text('title', isset($post) ? $post->title : old('title'), ['class' => 'form-control', 'placeholder' => __('messages.common.title'), 'required', 'id' => 'postTitle']) }}
                                <button type="button" class="btn btn-primary ms-3 w-25" id="OpenAiCall"
                                    data-role="{{ getLoginUserRole() }}">{{ __('messages.ai.generate_content') }}</button>
                                <button class="btn btn-primary ms-3 " type="button" data-bs-toggle="offcanvas"
                        ...
                        <div class="mb-5">
                            <div class="form-check form-switch form-check-custom form-check-solid">
                                <input class="form-check-input w-30px h-20px is-active" name="visibility"
                                    ...
                                    {{ !empty($post) && $post->visibility == 1 ? 'checked' : (old('visibility') ? 'checked' : '') }}>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row mt-2">
                    <div class="col-lg-4 mb-4">
                        <label class="form-label">{{ __('messages.post.add_to_featured') }}</label>
                    </div>
                    <div class="col-md-2">
                        <div class="mb-5">
                            <div class="form-check form-switch form-check-custom form-check-solid">
                                <input class="form-check-input w-30px h-20px is-active" name="featured" type="checkbox"
                                    value="1"
                                    {{ !empty($post) && $post->featured == 1 ? 'checked' : (old('featured') ? 'checked' : '') }}>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row mt-2">
                    <div class="col-lg-4 mb-4">
                        <label class="form-label">{{ __('messages.post.add_on_headline') }}</label>
                    </div>
                    <div class="col-md-2">
                        <div class="mb-5">
                            <div class="form-check form-switch form-check-custom form-check-solid">
                                <input class="form-check-input w-30px h-20px is-active" name="show_on_headline"
                                    type="checkbox" value="1"
                                    {{ !empty($post) && $post->show_on_headline == 1 ? 'checked' : (old('show_on_headline') ? 'checked' : '') }}>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row mt-2">
                    <div class="col-lg-4 mb-4">
                        <label class="form-label">{{ __('messages.post.add_to_breaking') }}</label>
                    </div>
                    <div class="col-lg-2 mb-4 ">
                        <div class="form-check form-check-custom form-check-solid">
                            <input class="form-check-input" type="checkbox" name="breaking" value="1"
                                {{ !empty($post) && $post->breaking == 1 ? 'checked' : (old('breaking') ? 'checked' : '') }}>
                        </div>
                    </div>
                </div>
                <div class="row mt-2">
                    <div class="col-lg-4 mb-4">
                        <label class="form-label">{{ __('messages.post.add_to_slider') }}</label>
                    </div>
                    <div class="col-lg-2 mb-4">
                        <div class="form-check form-check-custom form-check-solid">
                            <input class="form-check-input" type="checkbox" name="slider" value="1"
                                {{ !empty($post) && $post->slider == 1 ? 'checked' : (old('slider') ? 'checked' : '') }}>
                        </div>
                    </div>
                </div>
                <div class="row mt-2">
                    <div class="col-lg-4 mb-4">
                        <label class="form-label">{{ __('messages.post.add_to_recommended') }}</label>
                    </div>
                    <div class="col-lg-2 mb-4">
                        <div class="form-check form-check-custom form-check-solid">
                            <input class="form-check-input" type="checkbox" name="recommended" value="1"
                                {{ !empty($post) && $post->recommended == 1 ? 'checked' : (old('recommended') ? 'checked' : '') }}>
                        </div>
                    </div>
                </div>
                <div class="row mt-2">
                    <div class="col-lg-4 mb-4">
                        <label class="form-label">{{ __('messages.post.show_registered_user') }}</label>
                    </div>
                    <div class="col-lg-2 mb-4">
                        <div class="form-check form-check-custom form-check-solid">
                            <input class="form-check-input" type="checkbox" name="show_registered_user" value="1"
                                {{ !empty($post) && $post->show_registered_user == 1
                                    ? 'checked'
                                    : (old('show_registered_user')
                                        ? 'checked'
                                        : '') }}>
                        </div>
                    </div>
                ...
                @elseif($sectionType == \App\Models\Post::VIDEO_TYPE_ACTIVE)
                    ...
                    {{--                        {{__('messages.post.add_image') }} --}}
                    {{--                    </button> --}}
                    <textarea name="video_content" class="tox-target video-text-description form-control" id="videoContent"
                        rows="25">
                ...
                @elseif($sectionType == \App\Models\Post::AUDIO_TYPE_ACTIVE)
                    ...
                    {{--                        {{__('messages.post.add_image') }} --}}
                    {{--                    </button> --}}
                    <textarea name="audio_content" class="tox-target audio-text-description form-control" id="audioContent"
                        rows="25">
                ...
                @elseif($sectionType == \App\Models\Post::OPEN_AI_ACTIVE)
                    ...
                    {{--                        {{__('messages.post.add_image') }} --}}
                    {{--                    </button> --}}
                    <textarea name="article_content" class="tox-target article-text-description form-control" id="AiArticleContent"
                        rows="25">
                    {!! $post->postArticle->article_content ?? old('article_content') !!}
                    </textarea>
                @endif
...
<div class="col-xl-4">
            ...
            <div class="card-body">
                <nav>
                    <div class="nav nav-tabs" id="nav-tab" role="tablist">
                        <button class="nav-link active required" id="nav-video-tab" data-bs-toggle="tab"
                            data-bs-target="#nav-video" type="button" role="tab" aria-controls="nav-video-tab"
                            aria-selected="true"> {{ __('messages.post.get_video') . ':' }}</button>
                        <button class="nav-link required" id="nav-upload-video-tab" data-bs-toggle="tab"
                            data-bs-target="#nav-upload-video" type="button" role="tab"
                            aria-controls="nav-upload-video-tab"
                            aria-selected="false">{{ __('messages.post.upload_video') . ':' }}</button>
                    </div>
                </nav>
                <div class="tab-content mt-3" id="nav-tabContent">
                    <div class="tab-pane fade show active" id="nav-video" role="tabpanel"
                        ...
                        <div class="getVideoUrl">
                            ...
                            <button type="button"
                                class="btn btn-primary text-white get-video-by-url d-flex ms-auto mb-4" id="getVideo"
                                name="getVideo">{{ __('messages.post.get_video') }}</button>
                            <label for=""
                                class="form-label">{{ __('messages.post.video_embed_code') }}:</label>
                            ...
                            <div class="video_i_frame col-12">
                                @if (!empty($post->postVideo) && !empty($post->postVideo->video_embed_code))
                                    <iframe src="{{ $post->postVideo->video_embed_code }}" frameborder="0"
                                        width="280" height="250"></iframe>
                                @endif
                            </div>
                        </div>
                    </div>
                    <div class="tab-pane fade" id="nav-upload-video" role="tabpanel"
                        aria-labelledby="nav-upload-video-tab">
                        <div class="uploadVideo">
                            {{ Form::label('file', __('messages.post.upload_video'), ['class' => 'form-label mb-3']) }}
                            <input type="file" name="uploadVideo" class="form-control" id="uploadVideo"
            ...
            <div class="card-body">
                <div class="mb-3" io-image-input="true">
                    <label for="exampleInputImage"
                        class="form-label required">{{ __('messages.post.video_thumbnail') }}
                        :</label>
                    @php
                        ...
                        <div class="image-picker">
                            ...
                            <span class="picker-edit rounded-circle text-gray-500 fs-small" data-bs-toggle="tooltip"
                                ...
                                <label>
                                    ...
                                    <input type="file" name="thumbnailImage" class="image-upload d-none"
                                        id="thumbnailImage" accept=".png, .jpg, .jpeg, .webp, .svg" />
                                </label>
                            </span>
                        </div>
                    </div>
            ...
            <div class="card-body">
                <div class="form-group">
                    <div class="mb-5 col-lg-12">
                        ...
                        <span data-bs-toggle="tooltip" data-bs-placement="right" title="{{ __('messages.post.additional_image_dimensions_must_be_310X290') }}">
                            <i class="fa fa-question-circle"aria-hidden="true"></i>
                        </span>
                        <input type="file" class="form-control" id="additionalImage"
                            accept=".png, .jpg, .jpeg,.webp,.svg" name="additional_images[]" multiple="multiple">
                    </div>
                    <div class="mb-5 col-lg-12">
                        <div class="row">
                            <div id="preview" class="additional-images">
                                @if(isset($post->additional_image))
                                    @foreach ($post->media as $image)
                                        @if ($image->collection_name == 'additional images')
                                            <div class="d-inline-block mt-3 me-2 image-div-{{ $image->id }} ">
                                                <div class="additional-image-picker">
                                                    <div>
                                                        <img class="border-color" src="{{ $image->getFullUrl() }}"/>
                                                    </div>
                                                    <span class="picker-edit rounded-circle text-gray-500 fs-small" data-bs-toggle="tooltip"
                                                        data-placement="top"
                                                        data-bs-original-title="delete">
                                                        <label>
                                                            <button type="button" class="btn btn-sm-danger delete-additional-img-btn"
                                                                data-image="{{ $image->id }}"><i class="fa-solid fa-trash text-danger"></i></button>
                                                        </label>
                                                    </span>
                                                </div>
                                            </div>
    ...
    @if ($sectionType == \App\Models\Post::AUDIO_TYPE_ACTIVE)
        <div class="card mb-6">
            <div class="card-body">
                <div class="mb-5 col-lg-12">
                    {{ Form::label('file', __('messages.post.audio') . ':', ['class' => 'form-label mb-3 required']) }}
                    <input type="file" class="form-control" name="audios[]" multiple id="audios"
                        accept=".mp3, .M4A,.wav,.aac,.wma" onchange="javascript:updateAudioList()" />
    ...
    @endif
    @if (
        $sectionType == \App\Models\Post::ARTICLE_TYPE_ACTIVE ||
            $sectionType == \App\Models\Post::VIDEO_TYPE_ACTIVE ||
            $sectionType == \App\Models\Post::AUDIO_TYPE_ACTIVE)
        <div class="card mb-6">
            <div class="card-body">
                <div class="mb-5 col-lg-12">
                    ...
                    <div id="fileList">
                        @if(isset($post->post_file))
                            @foreach ($post->media as $media)
                                @if ($media->collection_name == 'post file')
                                    <div class="d-flex align-items-center file-div-{{ $media->id }}">
                                        <ul class="list-inline m-0">
                                            <li class="list-inline-item">{{ basename($media->original_url) }}</li>
                                        </ul>
                                        <button type="button" class="btn btn-sm btn-sm-danger ml-5 delete-post-file-btn" data-file="{{ $media->id }}">
        ...
        <div class="card-body">
            <div class="row mt-2">
                ...
                <div class="col-lg-8 mb-4">
                    <label class="form-label">{{ __('messages.post.scheduled_post') }}</label>
                    <input class="form-check-input ms-5" id="scheduledPost" type="checkbox" name="scheduled_post"
                        value="1" {{ !empty($post) && $post->scheduled_post === 1 ? 'checked' : '' }}>
                </div>
                <div class="mb-5 d-none date-time">
                    <input type="text" name="scheduled_post_time" id="scheduledPostTime"
                        class="form-control {{ getLogInUser()->dark_mode ? 'bg-light' : 'bg-white' }}"
                        autocomplete="off" placeholder="{{ __('messages.post.d&t') }}"
                        value="{{ isset($post) ? $post->scheduled_post_time : null }}">
                </div>
                <h6 class="mb-3">{{ __('messages.delete') }}</h6>
                <div class="col-lg-8 mb-4">
                    <label class="form-label">{{ __('messages.post.scheduled_post') }}</label>
                    <input class="form-check-input ms-5" id="scheduledPostDelete" type="checkbox"
                        name="scheduled_post_delete" value="1"
                        {{ !empty($post) && $post->scheduled_post_delete === 1 ? 'checked' : '' }}>
                </div>
            </div>
            <div class="mb-5 d-none  delete-date-time">
                <input type="text" name="scheduled_delete_post_time" id="scheduledPostDeleteTime"
                    class="form-control {{ getLogInUser()->dark_mode ? 'bg-light' : 'bg-white' }}" autocomplete="off"
                    placeholder="{{ __('messages.post.pick_date') }}"
                    value="{{ isset($post) ? $post->scheduled_delete_post_time : null }}">
            </div>
        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight"
            ...
            <div class="offcanvas-body">
                <div class="mb-5">
                    ...
                    {{ Form::select('openai', \App\Models\Post::MODEL, \App\Models\Post::GPT_4, ['class' => 'form-select form-select-solid', 'id' => 'openAi', 'data-control' => 'select2']) }}
                ...
                <div class="mb-5">
                    ...
                    <input type="range" id="Temperature" class="form-range" data-bs-toggle="tooltip"
                        data-placement="top"
                        data-bs-original-title="{{ __('messages.placeholder.controls_randomness_lowering_results_in_less_random_completions') }}"
                        value="0" min="0" max="1" step="0.01"
                        oninput="TemperatureOutput.value = Temperature.value">
                </div>
                <div class="mb-5">
                    <div class="d-flex justify-content-between">
                    ...
                    <input type="range" id="MaximumLength" class="form-range" data-bs-toggle="tooltip"
                        data-placement="top"
                        data-bs-original-title="{{ __('messages.placeholder.the_maximum_number_of_tokens_to_generate_requests_can_use_up') }}"
                        value="100" min="1" max="4000"
                        oninput="MaximumLengthOutput.value = MaximumLength.value">
                </div>
                <div class="mb-5">
                    <div class="d-flex justify-content-between">
                    ...
                    <input type="range" id="InputTopPId" class="form-range" value="0" min="0"
                        max="1" step="0.01" data-bs-toggle="tooltip" data-placement="top"
                        data-bs-original-title="{{ __('messages.placeholder.controls_diversity_via_nucleus_sampling') }}"
                        oninput="topP.value = InputTopPId.value">
                </div>
                <div class="mb-5">
                    <div class="d-flex justify-content-between">
                    ...
                    <input type="range" id="InputBestOfId" class="form-range" value="0" min="0"
                        max="20" step="0.01" data-bs-toggle="tooltip"
                        data-bs-original-title="{{ __('messages.placeholder.generates_multiple_completions_server_side') }}"
                        oninput="BestOf.value = InputBestOfId.value">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-xl-8 mt-5">
                ...
                <div class="accordion mt-5" id="kt_accordion_{{ $key + 1 }}">
                    <div class="accordion-item">
                        <h2 class="accordion-header d-flex align-items-center border-bottom-0"
                            ...
                            <button class="accordion-button accordion-button-{{ $postGallery->id }} fs-4 fw-bold"
                                type="button" data-bs-toggle="collapse"
                                data-bs-target="#kt_accordion_{{ $key + 1 }}_body_{{ $key + 1 }}"
                                aria-expanded="true"
                                aria-controls="kt_accordion_{{ $key + 1 }}_body_{{ $key + 1 }}"
                                {{ $inStyle }}="{{ $style }}
                            ">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 mb-5">
                                        ...
                                        <input type="text" name="gallery_title[]"
                                            ...
                                            id="postGalleryTitle" value="{{ $postGallery->gallery_title ?? null }}"
                                            placeholder={{ __('messages.common.title') }}
                                            data-id="{{ $postGallery->id }}">
                                    </div>
                                    ...
                                    <div class="col-md-9 add-post-text-editor mt-md-0 mt-4">
                                        ...
                                        {{--                                        {{__('messages.post.add_image') }} --}}
                                        {{--                                    </button> --}}
                                        <textarea name="gallery_content[{{ $loop->index }}]" class="tox-target text-gallery-description form-control"
                                            rows="25">
            ...
            <div class="row mt-5">
                <div class="col-sm-12 text-center">
                    <button type="button" id="postAddItem"
                        class="btn btn-md btn-success text-white btn-add-post-item">
                            ...
                            <div class="accordion-body border-top">
                                <div class="row">
                                    ...
                                    <div class="col-md-9 add-post-text-editor mt-md-0 mt-4">
                                        ...
                                        {{--                                    {{__('messages.post.add_image') }} --}}
                                        {{--                                </button> --}}
                                        <textarea name="gallery_content[]" class="tox-target text-gallery-description" height="200px">
                                            {!! $post->content ?? null !!}
                                        </textarea>
                                    </div>
                                </div>
            ...
            @foreach ($post->postSortLists as $key => $sortedList)
                <div class="accordion mt-5" id="kt_accordion_{{ $key + 1 }}">
                    <div class="accordion-item">
                        <h2 class="accordion-header d-flex align-items-center border-bottom-0"
                            id="kt_accordion_{{ $key + 1 }}_header_{{ $key + 1 }}">
                            <button class="accordion-button accordion-button-{{ $sortedList->id }} fs-4 fw-bold"
                                type="button" data-bs-toggle="collapse"
                                data-bs-target="#kt_accordion_{{ $key + 1 }}_body_{{ $key + 1 }}"
                                aria-expanded="true"
                                aria-controls="kt_accordion_{{ $key + 1 }}_body_{{ $key + 1 }}"
                                {{ $inStyle }}="{{ $style }}"
                                id="accordion_button_{{ $sortedList->id }}">
                                {{ $sortedList->sort_list_title ?? null }}
                            </button>
                        ...
                        <div id="kt_accordion_{{ $key + 1 }}_body_{{ $key + 1 }}"
                            ...
                            <div class="accordion-body border-top">
                                <div class="row">
                                    ...
                                    <div class="col-12 mb-5">
                                        <label class="form-label">{{ __('messages.common.title') }}</label>
                                        <input type="text" name="sort_list_title[]"
                                            class="form-control form-control-solid
                                                        {{ $loop->first ? 'sort-list-title' : '' }} sort-list-title-{{ $sortedList->id }} sort-list-title-text"
                                            id="sortListTitle" value="{{ $sortedList->sort_list_title ?? null }}"
                                            placeholder={{ __('messages.common.title') }}
                                            data-id="{{ $sortedList->id }}">
                                    </div>
                                    <div class="col-md-3 mt-5">
                                        <div class="mb-3" io-image-input="true">
                                            <label for="exampleInputImage"
                                            ...
                                            <div class="d-block">
                                                ...
                                                <div class="image-picker">
                                                    ...
                                                    <span class="picker-edit rounded-circle text-gray-500 fs-small"
                                                        ...
                                                        <label>
                                                            <i class="fa-solid fa-pen" id="profileImageIcon"></i>
                                                            <input type="file" name="sorted_list_image[]"
                                                                class="image-upload d-none" accept="image/*" />
                                                        </label>
                                                    </span>
                                                </div>
                                    ...
                                    <div class="col-md-9 add-post-text-editor mt-md-0 mt-4">
                                        ...
                                        {{--                                        {{__('messages.post.add_image') }} --}}
                                        {{--                                    </button> --}}
                                        <textarea id="kt_docs_tinymce_plugins" name="sort_list_content[{{ $loop->index }}]"
                                            class="tox-target text-sort_list-description" height="200px">
                                            ...
                                            <div class="d-block">
                                                <div class="image-picker">
                                                    ...
                                                    <span class="picker-edit rounded-circle text-gray-500 fs-small"
                                                        ...
                                                        <label>
                                                            <i class="fa-solid fa-pen" id="profileImageIcon"></i>
                                                            <input type="file" name="sort_list_images[]"
                                                                class="image-upload d-none" accept="image/*" />
                                                        </label>
                                                    </span>
                                                </div>
