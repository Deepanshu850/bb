<div id="addCategoriesModal" class="modal fade" role="dialog" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            {{ Form::open(['id' => 'addNewCategories', 'files' => true]) }}
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    {{ Form::label('name', __('messages.category_image') . ' :', ['class' => 'form-label required']) }}
                    <div class="form-group col-sm-12 mb-5">
                           <div class="image-picker">
                               <div class="image previewImage " id="category_image"></div>
                               <span class="picker-edit rounded-circle text-gray-500 fs-small" data-bs-toggle="tooltip" title="{{ __('messages.category_image') }}">
                                   <label>
                                       <i class="fa-solid fa-pen" id="cat_imageIcon"></i>
                                       <input type="file" id="cat_img" name="category_image" class="image-upload d-none" accept="image/*" />
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        <div
                            ...
                            <input class="form-check-input cursor-pointer is-active" name="show_in_menu" type="checkbox"
                                value="1" checked>
                        </div>
                    </div>
                    <div class="form-group col-sm-6">
                        ...
                        <div
                            class="form-check form-switch form-check-custom form-check-solid form-switch-sm d-flex justify-content-start cursor-pointer">
                            <input class="form-check-input cursor-pointer is-active" name="show_in_home_page"
