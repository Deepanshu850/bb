<div id="editCategoriesModal" class="modal fade" role="dialog" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            {{ Form::open(['id'=>'editCategories', 'files' => true]) }}
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-12 mb-5">
                           <div class="image-picker">
                               <div class="image previewImage" id="category_img"></div>
                               <span class="picker-edit rounded-circle text-gray-500 fs-small" data-bs-toggle="tooltip" title="{{ __('messages.category_image') }}">
                                   <label>
                                       ...
                                       <input type="file" id="cat_image" name="category_image" class="image-upload d-none" accept="image/*" />
