                    ...
                    <div class="col-lg-8">
                        <div class="leave-message-section bg-light px-30 py-4">
                            ...
                            <form id="contactUsFrom" >
                                <div class="row">
                                    <div class="col-md-4">
                                        <input type="text" name="name" class="form-control fs-14 text-gray" placeholder="{{__('messages.comment.enter_your_name')}}" style="color:rgb(115, 113, 113) !important">
                                    </div>
                                    <div class="col-md-4">
                                        <input type="email" name="email" class="form-control fs-14 text-gray" placeholder="{{__('messages.comment.enter_your_email')}}" style="color:rgb(115, 113, 113) !important">
                                    </div>
                                    <div class="col-md-4">
                                        {{-- <input type="number" name="phone" class="form-control fs-14 text-gray" placeholder="{{__('messages.comment.enter_phone_number')}}" style="color:rgb(115, 113, 113) !important"> --}}
                                        <input type="tel" name="phone" class="form-control fs-14 text-gray required" oninput="this.value = this.value.replace(/[^0-9]/g, '')" placeholder="{{__('messages.comment.enter_phone_number')}}" style="color: rgb(115, 113, 113) !important">

                                    </div>
                                    <div class="col-12">
                                        <textarea name="message" class="form-control fs-14 text-gray" rows="3" placeholder="{{__('messages.comment.type_your_comments')}}" style="color:rgb(115, 113, 113) !important"></textarea>
                                    </div>
