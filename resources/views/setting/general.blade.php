                                    ...
                                    <div class="row mb-7">
                                             <tr >
                                                 <div class="form-check form-switch form-check-custom form-check-solid">
                                                     ...
                                                     <input type="checkbox" name="stripe_checkbox_btn" class="form-check-input w-30px h-20px" id="stripeCheckboxBtn" {{ isset($setting['stripe_checkbox_btn']) && $setting['stripe_checkbox_btn'] == 1 ? 'checked' : '' }} value="1">
                                                 </div>
                                         ...
                                         <div class="row mb-7">
                                             <tr >
                                                 <div class="form-check form-switch form-check-custom form-check-solid">
                                                     ...
                                                     <input type="checkbox" name="paypal_checkbox_btn" class="form-check-input w-30px h-20px" id="paypalCheckboxBtn" {{ isset($setting['paypal_checkbox_btn']) && $setting['paypal_checkbox_btn'] == 1 ? 'checked' : '' }} value="1">
                                                 </div>
                                         ...
                                         <div class="row mb-7">
                                             <tr >
                                                 <div class="form-check form-switch form-check-custom form-check-solid">
                                                     ...
                                                     <input type="checkbox" name="manually_checkbox_btn" class="form-check-input w-30px h-20px" id="manuallyCheckboxBtn" {{ isset($setting['manually_checkbox_btn']) && $setting['manually_checkbox_btn'] == 1 ? 'checked' : '' }} value="1">
                                                 </div>
                                             </tr>
                                         </div>
                                </tbody>
