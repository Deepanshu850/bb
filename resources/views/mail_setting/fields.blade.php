...
<div class="mt-10">
    <div class="card">
        <div class="card-header">
            <h2>{{ __('messages.mails.test_mail')}}</h2>
        </div>
        <div class="card-body pt-0">
            {!! Form::open(['route' => ['mails-send-test'], 'method' => 'POST']) !!}
            <div class="row">
                <div class="mb-5">
                    {{ Form::label('test_mails', __('messages.emails.email').' :', ['class' => 'form-label mb-3']) }}
                    {{ Form::email('test_mails',  null, ['class' => 'form-control','placeholder' =>  __('messages.emails.email')]) }}
                </div>
            </div>
            {{ Form::submit(__('messages.common.send_email'),['class' => 'btn btn-primary me-2']) }}
            {{ Form::close() }}
        </div>
    </div>
</div>
